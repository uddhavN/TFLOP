...
def train(config):
    ...
    max_steps=config.training.get("max_steps", 250),
...
if __name__ == "__main__":
    ...
    print(">>> Merged Config Keys:")
    print("dataset_path:", config.get("dataset_path", None))
    print("train_metadata_file:", config.get("train_metadata_file", None))
    print("val_metadata_file:", config.get("val_metadata_file", None))
    print("dataset_script_path:", config.get("dataset_script_path", None))
    print("dataset_class_name:", config.get("dataset_class_name", None))
    print(">>> Config check before training:")
    print("  dataset_path         =", config.get("dataset_path", None))
    print("  train_metadata_file =", config.get("train_metadata_file", None))
    print("  val_metadata_file   =", config.get("val_metadata_file", None))
    print("  data_config source  =", args.data_config)
